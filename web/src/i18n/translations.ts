...
export const translations = {
  en: {
    ...
    startupMessages1: 'Starting AI intelligent quantitative system...',
    startupMessages2: '✓ API server started on port 8080',
    startupMessages3: '✓ Web console http://localhost:3001',
    ...
    step1Desc:
      'git clone https://github.com/akuntk/ai-trading to get the latest AI quantitative trading system.',
    ...
    riskWarningText:
      'Do not use funds you cannot afford to lose. NOFX is non-custodial, no official strategies. Trading involves risks, invest carefully.',
  ...
  zh: {
    ...
    startupMessages1: '启动AI智能量化系统...',
    startupMessages2: '✓ API服务器启动在端口 8080',
    startupMessages3: '✓ Web控制台 http://localhost:3001',
    ...
    step1Desc:
      'git clone https://github.com/akuntk/ai-trading 获取最新的AI智能量化交易系统。',
    step2Title: '配置环境',
    step2Desc:
    ...
    riskWarningText:
      '勿用无法承受损失的资金。NOFX 非托管，无官方策略。交易有风险，投资需谨慎。',
